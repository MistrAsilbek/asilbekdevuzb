            ...
            <div className="space-y-6">
              <GlassCard depth="medium">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:asilbekcoder111@gmail.com" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                      asilbekcoder111@gmail.com
                    </a>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard depth="medium">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <a
                    href="https://github.com/MistrAsilbek"
                    target="_blank"
                  ...
                  <a
                    href="https://instagram.com/asilbekdev"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="h-14 rounded-2xl bg-white/10 dark:bg-white/5 hover:bg-white/20 dark:hover:bg-white/10 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  >
                  ...
                  <a
                    href="https://www.youtube.com/@MistrAsilbek"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="h-14 rounded-2xl bg-white/10 dark:bg-white/5 hover:bg-white/20 dark:hover:bg-white/10 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  >
