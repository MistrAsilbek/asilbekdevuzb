...
export function Resume() {
  const skills = [
{ name: 'Python', level: 98, color: 'bg-gradient-to-r from-yellow-400 to-blue-500' },
{ name: 'PHP', level: 90, color: 'bg-gradient-to-r from-indigo-500 to-purple-500' },
{ name: 'Django', level: 88, color: 'bg-gradient-to-r from-green-600 to-emerald-500' },
{ name: 'HTML', level: 95, color: 'bg-gradient-to-r from-orange-500 to-red-500' },
{ name: 'CSS', level: 93, color: 'bg-gradient-to-r from-blue-500 to-cyan-500' },
{ name: 'JavaScript', level: 91, color: 'bg-gradient-to-r from-yellow-300 to-yellow-500' },
{ name: 'React', level: 90, color: 'bg-gradient-to-r from-cyan-400 to-blue-500' },
{ name: 'Next.js', level: 87, color: 'bg-gradient-to-r from-gray-700 to-gray-900' },
{ name: 'Tailwind CSS', level: 92, color: 'bg-gradient-to-r from-cyan-500 to-teal-500' },
{ name: 'Node.js', level: 85, color: 'bg-gradient-to-r from-green-500 to-emerald-500' },
{ name: 'Express.js', level: 84, color: 'bg-gradient-to-r from-gray-600 to-gray-800' },
{ name: 'MongoDB', level: 86, color: 'bg-gradient-to-r from-green-500 to-lime-500' },
{ name: 'PostgreSQL', level: 83, color: 'bg-gradient-to-r from-blue-700 to-sky-500' },
...
const education = [
  ...
  },
  {
    ...
    institution: 'Jizzaxdagi IT Parkda',
    period: '2025-boshlab',
    description: 'Universitetda dasturlashni NodeJs dan boshlab organishni boshladim',
  },
];
